...
<title><?php echo $__env->yieldContent('page-title', 'Restaurante'); ?></title>
<style>
...
<aside class="sidebar">
  ...
  <div class="sb-user">
    ...
    <div>
      ...
      <div class="sb-urole">
        <?php $rl=['gerente'=>'Gerente','garcom'=>'Garçom','chef'=>'Chef','caixa'=>'Caixa'] ?>
        <?php echo e($rl[Auth::user()->role] ?? Auth::user()->role); ?>
  ...
  <nav>
    ...
    <a href="<?php echo e(route('dashboard.pedidos')); ?>" class="<?php echo e(request()->routeIs('dashboard.pedidos','orders.show') ? 'active' : ''); ?>">
      <div class="nav-ic">🧾</div> Pedidos
    </a>

    <?php if(in_array(Auth::user()->role,['gerente','garcom'])): ?>
    <div class="sb-section">Salão</div>
    <a href="<?php echo e(route('mesas.index')); ?>" class="<?php echo e(request()->routeIs('mesas.*') ? 'active' : ''); ?>">
      <div class="nav-ic">🪑</div> Mesas
    </a>
    <?php endif; ?>

    <?php if(Auth::user()->role === 'garcom'): ?>
    <a href="<?php echo e(route('orders.create')); ?>" class="<?php echo e(request()->routeIs('orders.create') ? 'active' : ''); ?>">
      <div class="nav-ic">➕</div> Novo Pedido
    </a>
    <?php endif; ?>

    <?php if(Auth::user()->role === 'chef'): ?>
    <div class="sb-section">Cozinha</div>
    <a href="<?php echo e(route('chef.preparo')); ?>" class="<?php echo e(request()->routeIs('chef.preparo') ? 'active' : ''); ?>">
      <div class="nav-ic">🔥</div> Preparo
    </a>
    <a href="<?php echo e(route('chef.estoque')); ?>" class="<?php echo e(request()->routeIs('chef.estoque') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('caixa.pagar-mesa')); ?>" class="<?php echo e(request()->routeIs('caixa.*') ? 'active' : ''); ?>">
      <div class="nav-ic">💰</div> Caixa
    </a>
    <a href="<?php echo e(route('dashboard.estoque')); ?>" class="<?php echo e(request()->routeIs('dashboard.estoque') ? 'active' : ''); ?>">
      <div class="nav-ic">📦</div> Estoque
    </a>
    <?php endif; ?>
    ...
    <a href="<?php echo e(route('gerenciar.mesas')); ?>"        class="<?php echo e(request()->routeIs('gerenciar.mesas') ? 'active' : ''); ?>">
      <div class="nav-ic">🪑</div> Mesas
    </a>
    <a href="<?php echo e(route('gerenciar.cardapio')); ?>"     class="<?php echo e(request()->routeIs('gerenciar.cardapio*') ? 'active' : ''); ?>">
      <div class="nav-ic">🍽️</div> Cardápio
    </a>
    <a href="<?php echo e(route('gerenciar.funcionarios')); ?>" class="<?php echo e(request()->routeIs('gerenciar.funcionarios') ? 'active' : ''); ?>">
      <div class="nav-ic">👥</div> Funcionários
    </a>
    <a href="<?php echo e(route('gerenciar.produtos')); ?>"     class="<?php echo e(request()->routeIs('gerenciar.produtos*') ? 'active' : ''); ?>">
      <div class="nav-ic">📦</div> Produtos
    </a>

    <div class="sb-section">Relatórios</div>
    <a href="<?php echo e(route('gestao.relatorios')); ?>"      class="<?php echo e(request()->routeIs('gestao.relatorios') ? 'active' : ''); ?>">
      <div class="nav-ic">📊</div> Gestão
    </a>
    <a href="<?php echo e(route('dashboard.relatorios')); ?>"   class="<?php echo e(request()->routeIs('dashboard.relatorios') ? 'active' : ''); ?>">
      <div class="nav-ic">📄</div> Período
    </a>
    <a href="<?php echo e(route('dashboard.vendas')); ?>"       class="<?php echo e(request()->routeIs('dashboard.vendas') ? 'active' : ''); ?>">
      <div class="nav-ic">📈</div> Vendas
    </a>

    <div class="sb-section">Estoque</div>
    <a href="<?php echo e(route('controle.estoque')); ?>"       class="<?php echo e(request()->routeIs('controle.estoque*') ? 'active' : ''); ?>">
      <div class="nav-ic">🔄</div> Controle
    </a>
    <a href="<?php echo e(route('dashboard.estoque')); ?>"      class="<?php echo e(request()->routeIs('dashboard.estoque') ? 'active' : ''); ?>">
      <div class="nav-ic">📦</div> Inventário
    </a>
    <a href="<?php echo e(route('compras.index')); ?>"          class="<?php echo e(request()->routeIs('compras.*') ? 'active' : ''); ?>">
...
<div class="main">
  <div class="topbar">
    <div>
      ...
      <div class="bc"><?php echo $__env->yieldContent('breadcrumb','Sistema de Gestão'); ?></div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\project_corrigido\resources\views/layouts/app.blade.php ENDPATH**/ ?>