...
class OrderController extends Controller
{
    ...
    public function updateStatus(Request $request, Order $order)
    {
        ...
        // Se o pedido foi entregue, verificar se a mesa ficou sem pedidos ativos
        // e liberar a mesa automaticamente
        if ($novoStatus === 'entregue') {
            $pedidosAtivos = Order::where('table_id', $order->table_id)
                ->whereIn('status', ['aberto', 'em_preparo', 'pronto', 'pronto_entrega'])
                ->count();
