    ...
    public function index(): View
    {
        ...
        return match($user->role) {
            ...
            'garcom' => view('dashboard.garcom', [
                'mesas' => Table::with(['orders' => fn($q) => $q->whereIn('status', ['aberto', 'em_preparo', 'pronto', 'pronto_entrega'])])->orderBy('numero')->get(),
                ...
                'mesasOcupadas' => $mesasOcupadas,
                'totalMesas' => $totalMesas,
                'pedidosProntosPagamento' => Order::where('status', 'pronto_entrega')->with('table', 'items')->get(),
